...
using Dataocean.Venus.MultiTenancy.Demo;
...
namespace Dataocean.Venus.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(VenusConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
