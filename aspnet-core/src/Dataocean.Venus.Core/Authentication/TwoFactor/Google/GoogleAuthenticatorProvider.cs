...
namespace Dataocean.Venus.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : VenusServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Dataocean.Venus", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
