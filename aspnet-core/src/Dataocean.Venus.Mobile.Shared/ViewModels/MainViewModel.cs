...
using MvvmHelpers;
using Dataocean.Venus.Authorization.Users.Profile;
using Dataocean.Venus.Authorization.Users.Profile.Dto;
using Dataocean.Venus.Commands;
using Dataocean.Venus.Core.Threading;
using Dataocean.Venus.Models.NavigationMenu;
using Dataocean.Venus.Services.Navigation;
...
using Dataocean.Venus.ApiClient;
using Dataocean.Venus.Controls;
using Dataocean.Venus.Dto;
using Dataocean.Venus.Extensions;
using Dataocean.Venus.Localization;
using Dataocean.Venus.UI;
using Dataocean.Venus.UI.Assets;
using Dataocean.Venus.Views;
using DependencyResolver = Dataocean.Venus.Core.Dependency.DependencyResolver;
...
namespace Dataocean.Venus.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Venus";
