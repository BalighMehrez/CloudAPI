...
using Dataocean.Venus.Web.Public.Startup;
using Dataocean.Venus.Web.Session;

namespace Dataocean.Venus.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : VenusViewComponent
    {
