...
using Dataocean.Venus.Authentication.TwoFactor.Google;
using Dataocean.Venus.Authorization.Users.Dto;
using Dataocean.Venus.Authorization.Users.Profile.Cache;
using Dataocean.Venus.Authorization.Users.Profile.Dto;
using Dataocean.Venus.Dto;
using Dataocean.Venus.Friendships;
using Dataocean.Venus.Gdpr;
using Dataocean.Venus.Identity;
using Dataocean.Venus.Security;
using Dataocean.Venus.Storage;
using Dataocean.Venus.Timing;

namespace Dataocean.Venus.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : VenusAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Dataocean.Venus",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Dataocean.Venus",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
