...
namespace Dataocean.Venus.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : VenusAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<VenusDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(VenusConsts.ConnectionStringName).Value.ToString();
        }
