...
namespace Dataocean.Venus.Web.Authentication.JwtBearer
{
    public class VenusJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public VenusJwtSecurityTokenHandler()
        {
