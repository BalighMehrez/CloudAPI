...
using Dataocean.Venus.Configuration.Tenants;
using Dataocean.Venus.Timing;
using Dataocean.Venus.Timing.Dto;
using Dataocean.Venus.Web.Areas.AppAreaName.Models.Settings;
...
namespace Dataocean.Venus.Web.Areas.AppAreaName.Controllers
{
    ...
    public class SettingsController : VenusControllerBase
    {
