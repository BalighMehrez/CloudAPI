...
using Dataocean.Venus.Configuration.Host;
using Dataocean.Venus.Editions;
using Dataocean.Venus.Timing;
using Dataocean.Venus.Timing.Dto;
using Dataocean.Venus.Web.Areas.AppAreaName.Models.HostSettings;
...
namespace Dataocean.Venus.Web.Areas.AppAreaName.Controllers
{
    ...
    public class HostSettingsController : VenusControllerBase
    {
