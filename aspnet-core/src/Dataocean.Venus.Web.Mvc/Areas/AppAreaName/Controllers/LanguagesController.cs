...
using Dataocean.Venus.Web.Areas.AppAreaName.Models.Languages;
...
namespace Dataocean.Venus.Web.Areas.AppAreaName.Controllers
{
    ...
    public class LanguagesController : VenusControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = VenusConsts.LocalizationSourceName;
            }
