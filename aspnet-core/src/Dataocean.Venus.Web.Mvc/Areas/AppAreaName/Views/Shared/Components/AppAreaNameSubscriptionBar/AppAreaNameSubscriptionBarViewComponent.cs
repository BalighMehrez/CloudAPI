...
namespace Dataocean.Venus.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameSubscriptionBar
{
    public class AppAreaNameSubscriptionBarViewComponent : VenusViewComponent
    {
