...
namespace Dataocean.Venus.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTopBar
{
    public class AppAreaNameTopBarViewComponent : VenusViewComponent
    {
