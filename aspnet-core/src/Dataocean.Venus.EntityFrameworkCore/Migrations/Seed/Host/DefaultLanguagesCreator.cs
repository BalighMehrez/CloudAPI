...
namespace Dataocean.Venus.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = VenusConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(VenusDbContext context)
        {
            _context = context;
        }
